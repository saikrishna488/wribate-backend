...
const userSchema = new mongoose.Schema({
  ...
  dob: {
    type: Date,
    required: [false, ' A User Must Required A dob!'],
  },

  country: {
    type: String,
    required: [false, ' A User Must Required A country!'],
    trim: true,
  },
  userName: {
    type: String,
...
const verifiedUsersModel = mongoose.model('VerifiedUsers', verifiedUsersSchema);
...
export default { User, Wribate, Argument, Vote, Comment, Student, TempUser, Message, Razorpay, verifiedUsersModel }
